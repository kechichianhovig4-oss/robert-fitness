        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              William's Professional Sports Massage isn't just about relaxation. It's a clinical partnership dedicated to your athletic career. We combine anatomical expertise with high-performance recovery protocols.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-md p-10 rounded-2xl border border-white/10">
              ...
              <p className="text-lg italic mb-8 leading-relaxed">"The level of anatomical knowledge here is insane. As a CrossFitter, I need someone who understands functional movement. William is the best in the city."</p>
              <div>
