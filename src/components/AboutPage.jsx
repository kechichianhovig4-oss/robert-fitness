...
function AboutPage() {
    ...
    <div className="bg-white text-gray-800 min-h-screen">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 px-4 md:px-10 py-4 bg-white sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-xl font-extrabold tracking-tight text-gray-900">Robert's Sports Massage</h2>
        </div>
  ...
  <div className="flex flex-col md:flex-row gap-12 items-center">
    ...
    <div className="w-full md:w-2/3">
      <h3 className="text-2xl font-bold mb-6 text-blue-800">A Note From Robert</h3>
      ...
      <div className="mt-8">
        <p className="text-2xl font-bold text-orange-500">Robert Benedict, LMT</p>
  ...
  <div className="max-w-2xl mx-auto space-y-8">
    ...
    <p className="text-gray-600 text-lg">Join the community of athletes who trust Robert for their recovery and maintenance.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-600 text-sm">
              <div className="flex items-start gap-3">
                ...
                <span>robertfitness@mail.com</span>
              </div>
              <div className="flex items-start gap-3">
